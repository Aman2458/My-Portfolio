...
// Using Locomotive for smooth scrolling from locomotive https://github.com/locomotivemtl/locomotive-scroll
...
locoScroll.on("scroll", ScrollTrigger.update);
 ...
 ScrollTrigger.scrollerProxy("#main " , {
    ...
    getBoundingClientRect() {
        return{top: 0 , left:0, with: window.innerWidth, height: window.innerHeight};
    },
